      ...
      <div className={styles["container"]}>
        ...
        <div className={styles['product'] + " " + styles['col']}>
            <div className={['produt-container']}>
                ...
                <a href="/productsPage" className={styles['product-block']}>
                ...
                <div className={['add-Product-To-Cart--btn']}>
                  <div className={['centered--button']}>
                    <div className={styles['textbox-button']}>
                      <button aria-label="Add to Cart" className={styles['add-To-Cart--Btn']}>
                        <a data-bs-toggle="offcanvas" href="#offcanvasExample" role="button"
                        aria-controls="offcanvasExample" className={styles['icon']}>Add to Cart</a>
                      </button>
                    </div>
                  </div>
                </div>
