...
const Footer = () => (
    ...
    <footer>
    <div className={styles['footer-Container'] +" "+ styles['container-fluid']}>

      <div className={styles['email-Signup'] +" "+ ['row-col']}>
        <form id={styles['newsletter-form']} method="POST" action="">
          <div className={styles['block-content']}>
            <div className={styles['email-signup']}>
            <label className={styles['form__subscribe-header']}>
                🔔 Sign up for alerts 🔔
              </label>
              <label className={styles['form__subscribe-header']}>
                Be one of the first to get notified !
              </label>
      ...
      <div className={styles['links-container'] +" "+ ['container-fluid']}>
        <div className={styles['links'] +" "+ ['container']}>
          <div className={styles['quick-Links-Row'] +" "+ ['row']}>
            <div className={styles['internal-Links'] +" "+ ['container']}>

              <div className={styles['quick-Links'] +" "+ ['col']}>
            ...
            <div className={styles['external-Links'] +" "+ ['container']}>
              ...
              <div className={styles['social-Links'] +" "+ ['col']}>
                <div className={styles['social-Links-Text']}>
        ...
        <div className={styles['end-Links-Container'] +" "+ ['container']}>
          <div className={styles['row']}>
            <div className={styles['col']}>
              <ul className={styles['end-Links'] +" "+ ['list-group'] +" "+ ['list-group-horizontal']}>
                <li className={styles['end-Link']}><a href="">Privacy & Cookie Policy</a></li>
                <li className={styles['end-Link']}><a href="">Terms & Conditions</a></li>
              </ul>
            </div>
          </div>
        </div>
